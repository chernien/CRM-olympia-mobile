      ...
      <div className="flex items-center gap-5">
          ...
          trigger={
            <div className="flex items-center gap-3 px-3 py-1.5 bg-slate-50 rounded-full transition-all cursor-pointer hover:bg-slate-100 border border-slate-100">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm font-bold text-text-primary">Jason Ranti</span>
        ...
        >
          <div className="px-1 py-1">
            ...
            <div onClick={onLogout} className="flex items-center gap-3 px-3 py-2.5 rounded-subtle text-sm font-medium text-error transition-colors hover:bg-red-50 cursor-pointer">
              <LogOut size={16} />
